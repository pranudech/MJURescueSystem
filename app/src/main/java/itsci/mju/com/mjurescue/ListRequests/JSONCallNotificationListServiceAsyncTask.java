 ...
 */
public class JSONCallNotificationListServiceAsyncTask extends AsyncTask<String,String,String> {
    private CallNotificationListService callNotificationListService;
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            if(callNotificationListService!=null){
                callNotificationListService.onCallService();
            }
    ...
    public JSONCallNotificationListServiceAsyncTask(CallNotificationListService callNotificationListService) {
        this.callNotificationListService = callNotificationListService;
    }
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        if (callNotificationListService != null) {
            callNotificationListService.onPreCallService();
        }
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if (callNotificationListService != null) {
            ...
            callNotificationListService.onRequestCompleteListener(newsList);
        }
